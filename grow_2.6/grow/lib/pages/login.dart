          ...
          child: SingleChildScrollView(
            child: Stack(
              children: <Widget>[
                ...
                Padding(
                  padding: EdgeInsets.only(left: MediaQuery.of(context).size.width * 0.20, top: 540, bottom: 20),
                ...
                Padding(
                  padding: EdgeInsets.only(left: MediaQuery.of(context).size.width * 0.50, top: 540, bottom: 20),
                  child: GestureDetector(
                    onTap: () {
